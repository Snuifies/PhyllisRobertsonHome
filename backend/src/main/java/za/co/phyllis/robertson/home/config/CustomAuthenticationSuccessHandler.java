...
/**
 * Here we can override and manage Custom Authentication stuff when the user is logge din. Typically it can be used to manage URLS redirection, save sessions,
 * etc...
 *
 * @author snuif
 */
